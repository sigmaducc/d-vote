...
const Footer = () => {
  return (
    <div className="gradient-bg-footer w-full">
      <div className="max-w-[1600px] m-auto flex md:justify-center justify-between items-center flex-col p-4 ">
        ...
        <div className="sm:w-[90%] w-full flex justify-between items-center mt-3">
          ...
          <p className="text-slate-200 text-sm text-right">
            All rights reserved
          </p>
        </div>
      </div>
